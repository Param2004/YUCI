    ...
    <div className="bg-white py-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:py-24">
      <div className="relative max-w-xl mx-auto">
        ...
        <div className="text-center">
          <h2 className="text-4xl font-bold tracking-tight text-red-700 sm:text-4xl">Get in Touch</h2>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="py-3 px-4 block w-full shadow-sm focus:border-red-600 border-gray-300 rounded-md"
                />
              </div>
            </div>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="py-3 px-4 block w-full shadow-sm focus:ring-red-500 border-gray-300 rounded-md"
                />
              </div>
            </div>
