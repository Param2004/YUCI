  ...
  export default function Footer() {
    return (
      <footer className="bg-white" aria-labelledby="footer-heading">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:pt-16 lg:pb-8 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-8 xl:mt-0">
              <h3 className="text-sm font-semibold text-red-700 tracking-wider uppercase">
              ...
              <form className="mt-4 sm:flex sm:max-w-md">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-red-500 focus:border-red-500 focus:placeholder-gray-400"
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-sm text-gray-500 md:mt-0 md:order-1">
              &copy; 2024 YUCI Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
