      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-2 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <div className="relative group">
            ...
            <div
              className="absolute text-center -left-8 top-full z-10 overflow-hidden rounded-3xl w-screen max-w-60 bg-white shadow-lg ring-4 ring-gray-900/5 transition data-[closed]:translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in hidden group-hover:block"
            >
              <div className="p-4">
                {products.map((item) => (
                  <div
          ...
          {/* <Popover className="relative group">
            <PopoverButton className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 active:text-red-600 hover:text-red-600">
              <Link to='/forums'>
                Forums
              </Link>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link to='/join-us' className="text-sm font-semibold leading-6 text-white bg-red-600
          active:text-red-600 hover:text-red-600 border-red-600
           border-2
            px-2 py-1 rounded
          hover:bg-white
